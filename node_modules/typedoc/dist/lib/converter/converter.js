...
let Converter = Converter_1 = class Converter extends component_1.ChildableComponent {
    ...
    isExcluded(symbol) {
        var _a, _b;
        (_a = this.excludeCache) !== null && _a !== void 0 ? _a : (this.excludeCache = paths_1.createMinimatch(this.application.exclude));
        for (const node of (_b = symbol.getDeclarations()) !== null && _b !== void 0 ? _b : []) {
            if (paths_1.matchesAny(this.excludeCache, node.getSourceFile().fileName)) {
                return true;
            }
        }
        return false;
    ...
    isExternal(symbol) {
        ...
        for (const node of (_b = symbol.getDeclarations()) !== null && _b !== void 0 ? _b : []) {
            if (paths_1.matchesAny(this.externalPatternCache, node.getSourceFile().fileName)) {
                return true;
            }
        }
        return false;
